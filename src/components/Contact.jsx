...
const phoneNumber = "+923128050626"; // Replace with your WhatsApp number
    const message =
      "Hello! 👋 I am interested in your services. Can you provide more details?";
      ...
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
            ...
            colloborating on something amazing!
          </p>
          ...
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon}, key) => (
              <a
                ...
                className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-400 reveal-up"
                key={key}
                target="_blank"
              >
                {icon}
        ...
        <form
          action="https://getform.io/f/bmdpngja"
